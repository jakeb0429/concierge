...
# happy-hour scan 10:15 UTC — results ready before the 11:00 daily digest email
15 10 * * * cd $APP_DIR && npx tsx prisma/happy-hour-scan.ts >> /root/concierge-happyhour.log 2>&1
